...
class Controller:
    ...
    def dynamic_pid(self):
        ...
        # kp_lat, kd_lat, ki_lat = ...
                kp_lon, kd_lon, ki_lon = 0.1, 0.1, 0.1
                kp_lat, kd_lat, ki_lat = 0.1, 0.1, 0.1
        else:
        ...
        # kp_lat, kd_lat, ki_lat = ...
                ...
                '''kp_lat = kp_lat_base * 14
                kd_lat = kd_lat_base * 7
                ki_lat = ki_lat_base * 16
                
                kp_lon = kp_lon_base * 14
                kd_lon = kd_lon_base * 7
                ki_lon = ki_lon_base * 16'''
